            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul class="nav navbar-nav navbar-left navbar-user">
                    <li><a href="index.php" class="active">&nbsp; <span class='glyphicon glyphicon-home'></span> &nbsp;Home</a></li>
                                 <li class="active" class="dropdown user-dropdown">
...
$query=mysqli_query($dbcon,"select * from items where Action= 1 ");
...
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$query2['item_name']."</textarea>
           ...
           <a class='fancybox-buttons' href='item_images/".$query2['item_image']."' data-fancybox-group='button' title=' ".$query2['item_name']."'>
