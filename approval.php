...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active" ><a href="approval.php">&nbsp; <span class='glyphicon glyphicon-remove'></span> &nbsp; &nbsp; &nbsp; Products Approval</a></li>
                    <li ><a href="approvedproducts.php">&nbsp; <span class='glyphicon glyphicon-ok'></span> &nbsp; &nbsp; &nbsp; Approved Products</a></li>
       ...
       <div class="alert alert-danger">
                          ...
                          <center> <h3><strong>Products Approval</strong> </h3></center>
        ...
        <?php
include("config.php");
  $stmt = $DB_con->prepare('SELECT * FROM items where Action=0');
  $stmt->execute();
