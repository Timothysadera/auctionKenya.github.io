        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active"><a href="computer.php">&nbsp; <i class="fa fa-desktop"></i> &nbsp; &nbsp; &nbsp;Computer Accessories</a></li>
...
$query=mysqli_query($dbcon,"select * from items where Action= 1  AND Stock='computer'");
...
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$query2['item_name']."</textarea>
          ...
          <a class='fancybox-buttons' href='item_images/".$query2['item_image']."' data-fancybox-group='button'  ".$query2['item_name']."'>
					...
					<center><h4> Price: Ksh: ".$query2['item_price']." </h4></center>
					 ...
					 <a class='btn btn-block btn-info' href='add_to_cart.php?cart=".$query2['item_id']."'><span class='glyphicon glyphicon-info-sign'></span> Read More</a>
            </div>
          </div>
        </div>";
